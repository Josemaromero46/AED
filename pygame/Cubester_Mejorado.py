...
class Cubester:
    ...
    def __init__(self, screen, target_fps):
        ...
        #musica
        pygame.mixer.init()
        pygame.mixer.music.load('c:\\Users\\jose\\Documents\\UNAH\\SEXTO PERIODO\\ALGORITMOS Y ESTRUCTURA DE DATOS\\Cube\\neon.mp3')
    ...
    def run(self):
        ...
        while self.running:
            ...
            self.mostrar_tiempo(elapsed_time)
            pygame.display.flip()
    ...
    def mostrar_tiempo(self, elapsed_time):
        seconds = elapsed_time // 1000
        minutes = seconds // 60
        seconds %= 60
        milliseconds = elapsed_time % 1000

        tiempo_str = f"{minutes:02}:{seconds:02}.{milliseconds:03}"
        texto = self.font.render(tiempo_str, True, (255, 255, 255))
        self.screen.blit(texto, (300, 10))

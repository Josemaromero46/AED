...
# Carga el ícono
icon = pygame.image.load('img/myico.ico') 
...
# Definición de variables de acción del jugador
moving_left = False
moving_right = False
shoot = False
grenade = False
...
# Almacenar casillas en una lista
img_list = []
...
class Soldier(pygame.sprite.Sprite):
	def __init__(self, char_type, x, y, scale, speed, ammo, grenades):
		...
		self.update_time = pygame.time.get_ticks()
		 # Variables específicas de la IA
		self.move_counter = 0
...
restart_button = button.Button(SCREEN_WIDTH // 2 - 160, SCREEN_HEIGHT // 2 - 90, restart_img, 3)

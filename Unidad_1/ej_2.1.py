#2.1 A la clase Array en el programa Array.py (Listado 2-3), agregue un método llamado getMaxNum() 
#que devuelve el valor del más alto número en la matriz, o Ninguno si la matriz no tiene números.  
